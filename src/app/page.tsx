    ...
    <main>
      <div className="min-h-[90vh] flex items-center justify-center bg-green-custom-800 text-white">
        <div className="text-center">
          <h1 className="text-7xl font-bold mb-4">{localization[language].greeting}</h1>
          {isAuthorized ? (
            <>
              <p className="text-3xl mb-4">{localization[language].authorizedStatusPositive}</p>
              <Link
                href="/main"
            ...
            <>
              <p className="text-3xl mb-4">{localization[language].authorizedStatusNegative}</p>
